/*
 * Copyright (C) 2019-2020 The LegionOS
 *
...
public class StatusbarBatterySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.legion_settings_statusbar_battery);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.legion_settings_statusbar_battery;
                    result.add(sir);
                    return result;
                }
